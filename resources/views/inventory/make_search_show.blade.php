                        ...
                        <form class="cmxform form-horizontal adminex-form" >
                            ...
                            @if( $coupon['status'] == 2 )
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="state" >
                                            <span class="label label-warning" >{{$status[$coupon['status']]}}</span>
                                        </div>
                                    </div>
                                    <label for="name" class="control-label col-lg-1">不通过原因</label>
                                    <div class="col-lg-3">
                            ...
                            @else
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="state" >
                                            @if( $coupon['status'] == 1 )
                                                <span class="label label-info" >{{$status[$coupon['status']]}}</span>
                                            @elseif($coupon['status'] == 3)
                                                <span class="label label-success" >{{$status[$coupon['status']]}}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-default" onclick="location.href = '/inventory/make/search{{$urlParam}}'" type="button">确定</button>
                                </div>
                            </div>
                        </form>
                    </div>
