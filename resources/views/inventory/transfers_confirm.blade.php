...
@section('scripts')
    ...
    <script>
        $(".show").click(function () {
            var id = $(this).data('id');
            location.href = '/inventory/transfers/confirm/show?id='+ id;
        })
    </script>
...
@section('body')
    ...
    <form class="cmxform form-horizontal adminex-form" id="form" method="post" action="/inventory/transfers/confirm/save" >
