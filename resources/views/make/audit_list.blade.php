...
@section('body')
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <div class="panel-body">
                    <form class="cmxform form-horizontal adminex-form" method="get" action="/make/audit/list" >
    ...
    <form class="cmxform form-horizontal adminex-form" method="post" action="/make/audit/save" >
                                ...
                                @if(count($list) > 0)
                                    @foreach($list as $key => $value)
                                        <tr>
                                            ...
                                            <td><a class="btn-link data_link" href="/make/audit/show?id={{$value->id}}">{{$value->seq}}</a></td>
