                    ...
                    <div class="form">
                        <form class="cmxform form-horizontal adminex-form">
                            ...
                            <div class="form-group ">
                                ...
                                <label class="control-label col-lg-1">券类别</label>
                                <div class="col-lg-3">
                            ...
                            <div class="form-group ">
                                ...
                                <label class="control-label col-lg-1">所属仓库</label>
                                <div class="col-lg-3">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-default" onclick="location.href = '/sale/replace/list{{$urlParam}}'" type="button">确认</button>
                                </div>
                            </div>
                        </form>
                    </div>
