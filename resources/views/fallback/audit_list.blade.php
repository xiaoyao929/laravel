        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <div class="panel-body">
                    <form class="cmxform form-horizontal adminex-form" method="get" action="/exchange/fallback/audit/list" >
                                ...
                                @if(count($list) > 0)
                                    @foreach($list as $key => $value)
                                        <tr class="level1-box closed">
                                            <td><input type="checkbox" class="select_one" value="{{$value->sale_seq.'-'.$value->id}}" name="select_list[]"></td>
                                            <td><a class="btn-link data_link" href="/exchange/fallback/audit/show?id={{$value->id}}&sale_seq={{$value->sale_seq}}">{{$value->seq}}</a></td>
